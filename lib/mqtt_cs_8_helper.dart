...
class MqttHelper {
	...
	void disconnectedDisconnect([Object? data]) {
		callbackFunction.call(true,'Already disconnected', false);
	}
	...
	void disconnectedSubscribe([Object? data]) {
		callbackFunction.call(false,'Not connected', false);
	}
	...
	void awaitSubscribeConnect([Object? data]) {
		callbackFunction.call(true,'Already connected', false);
	}
